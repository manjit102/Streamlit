...
st.header('1. Plotting  the Chart with Random Numbers')
...
df = pd.read_csv(r'C:\Users\manji\OneDrive\Desktop\Streamlit\iris.csv')
st.dataframe(df)
...
st.header('3. Multiple Graphs in One Row')
