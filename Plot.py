...
df = pd.read_csv(r'C:\Users\manji\OneDrive\Desktop\Streamlit\lang_data.csv')
...
df = pd.read_csv(r'C:\Users\manji\OneDrive\Desktop\Streamlit\tips.csv')
...
fig = px.pie(df, values = 'total_bill', names = 'day', opacity = .9, color_discrete_sequence = px.colors.sequential.RdBu)
st.plotly_chart(fig)
